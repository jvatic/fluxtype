var assertDifference;

assertDifference = function(base_obj, method_chain, amount, callback, message) {
...
test("property chain changes by 1", function() {
  var obj;
  expect(1);
  obj = {
    foo: {
...
test("property changes by -3", function() {
  var obj;
  expect(1);
  obj = {
    foo: 1,
...
test("method changes by 2", function() {
  var obj;
  expect(1);
  obj = {
    count: 3,
